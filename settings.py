...
DATABASES = {
    'default': {
        ...
        'HOST': env['DOTCLOUD_DB_MONGODB_URL'], # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
    }
}
ENGINE="django_mongodb_engine"

#mongo engine connection defined here
...
STATICFILES_DIRS = (
    ...
    "./static",
    os.path.join(PROJECT_ROOT, 'current/static/'),
)
...
SECRET_KEY = 'q3=2yv96nnnxjq!-ayno3s47j&_k3j6x_l2@2^$ulm9bi3^a2e'
